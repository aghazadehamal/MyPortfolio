...
export const PROJECTS = [
  {
    image: `${process.env.PUBLIC_URL}/images/aghazadeh.jpeg`, // Projenizin bir ekran görüntüsünü veya temsil edici bir resmini burada belirtin.
    name: "Aghazadeh News",
  ...
  {
    image: `${process.env.PUBLIC_URL}/images/edurive.jpeg`, // Projenizin bir ekran görüntüsünü veya temsil edici bir resmini burada belirtin.
    name: "EduRive",
    technologyUsed: "ReactJs",
    description: "EduRive, kullanıcılarına online ehliyet dersleri sunan bir web platformudur. ReactJs kullanılarak geliştirilmiş bu platform, ehliyet almak isteyen bireyler için zengin içerik sunar ve öğrenme sürecini kolaylaştırır. Kullanıcı dostu arayüzü ile EduRive, teorik bilgilerden pratik uygulamalara kadar ehliyet sınavına hazırlık sürecindeki tüm ihtiyaçları karşılar. Platform, her cihazda sorunsuz bir kullanıcı deneyimi sağlamak için tasarlanmıştır ve modern web geliştirme teknikleri ile haber okuma deneyimini yeniden şekillendirir.",
...
export const TOOLS = ["Visual Studio Code", "Git", "Chrome DevTools", "Npm (Node Package Manager)", "Axios", "React js", "Postman"]
